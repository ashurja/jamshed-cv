...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {UC San Diego}{La Jolla, California, USA}
      {MS in Computer Engineering}{Sep 2022 \textbf{--} March/June 2024 (Expected)}
...
\section{Research Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeResearchheading{UC San Diego Research Assistant}{Jan 2022 - Present}
  ...
  \resumeSubHeadingListStart
    \resumeResearchheading{UC San Diego Graduate Teaching Assistant}{Jan 2023 \textbf{--} Present}
      \resumeClassheading{Computer Networks}{Professor Aaron Schulman}
        \resumeItemListStart
