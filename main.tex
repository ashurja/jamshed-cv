...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {BS/MS in Computer Engineering}{Sep 2018 \textbf{--} June 2023 (Expected)}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {CPU Architect Intern}{June 2023 \textbf{--} Present}
        \resumeItemListStart
            ...
            \resumeItem{Enhanced user experience by designing and refining the graphical user interface (GUI) of the tool, subsequently ensuring its smooth deployment across existing devices.}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Software Engineering Intern}{Jun 2019 \textbf{--} Sep 2019}
        \resumeItemListStart
            \resumeItem{Developed AR application utilizing C\# on iOS devices, revolutionizing the way scientists, researchers, and pharmaceutical companies analyze 3D protein structures without the requirement of a VR setup.}
...
\section{Research Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeResearchheading{UC San Diego Research Assistant}{January 2022 - Present}
      ...
      \resumeItemListStart
        \resumeItem{\href{https://conf.researchr.org/details/ecoop-issta-2023/ecoop-issta-2023-student-research-competition/7/-Characterizing-WebAssembly-Performance-in-the-Era-of-Serverless-Computing}{\textit{\underline{ISSTA 2023 SRC}}}}
  ...
  \vspace{3pt}
  \resumeSubHeadingListStart
    \resumeResearchheading{UC San Diego Graduate Teaching Assistant}{Jan 2023 \textbf{--} June 2023}
